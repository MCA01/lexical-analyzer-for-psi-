...
/*
 *  Mesut Cemil Aliağaoğlu - 05200000064
 *  Yusuf Kaynar - 05200000120
 *
 *  Hocam kod bazen sonucu farklı verebiliyor eksik veya yanlış çıktığında tekrar çalıştırırsanız düzelebilir.
 *
 *  HATALAR:
 *  -> String Constant'larda string içinde boşluk olduğunda hata yapıyor.
 *
 *  -> Comment'leri algılayamıyor.
 *
*/
